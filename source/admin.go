...
var admins = []model.SysUser{
	...
	{MODEL: global.MODEL{ID: 2, CreatedAt: time.Now(), UpdatedAt: time.Now()}, UUID: uuid.NewV4().String(), Username: "superUser", Password: "e10adc3949ba59abbe56e057f20f883e", NickName: "普通管理员", HeaderImg: "http://xxx/images/avatar.jpeg", AuthorityId: "1001"},
}
