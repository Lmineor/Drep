...
var carbines = []gormadapter.CasbinRule{
	...
	{Ptype: "p", V0: "999", V1: "/project/registryProject", V2: "POST"},
	{Ptype: "p", V0: "999", V1: "/project/getProjectDetail", V2: "GET"},
	{Ptype: "p", V0: "999", V1: "/project/listProjects", V2: "GET"},
	{Ptype: "p", V0: "999", V1: "/project/updateProject", V2: "PUT"},
	...
	{Ptype: "p", V0: "999", V1: "/dp/getDpDetail", V2: "GET"},
	{Ptype: "p", V0: "999", V1: "/dp/updateDpDetail", V2: "PUT"},
	{Ptype: "p", V0: "999", V1: "/dp/deleteDp", V2: "DELETE"},

	// admin
	{Ptype: "p", V0: "888", V1: "/base/login", V2: "POST"},
	{Ptype: "p", V0: "888", V1: "/base/register", V2: "POST"},

	{Ptype: "p", V0: "888", V1: "/project/registryProject", V2: "POST"},
	{Ptype: "p", V0: "888", V1: "/project/getProjectDetail", V2: "GET"},
	{Ptype: "p", V0: "888", V1: "/project/listProjects", V2: "GET"},
	{Ptype: "p", V0: "888", V1: "/project/updateProject", V2: "PUT"},
