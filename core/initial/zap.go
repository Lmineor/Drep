...
func getEncoderCore() (core zapcore.Core) {
	writer, err := utils.GetWriteSyncer() // use file-rotatelogs to separate logs
	if err != nil {
...
// CustomTimeEncoder define custom format for log's time
func CustomTimeEncoder(t time.Time, enc zapcore.PrimitiveArrayEncoder) {
	enc.AppendString(t.Format(global.CONFIG.Zap.Prefix + "2021/01/01 - 10:01:03.000"))
}
